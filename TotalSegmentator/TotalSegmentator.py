...
class TotalSegmentatorLogic(ScriptedLoadableModuleLogic):
    ...
    def __init__(self):
        ...
        self.totalSegmentatorLabelTerminology = {
            ...
            "gluteus_minimus_left": "Segmentation category and type - Total Segmentator~SCT^123037004^Anatomical Structure~SCT^75297007^Gluteus minius muscle~SCT^7771000^Left~Anatomic codes - DICOM master list~^^~^^|",
            "gluteus_minimus_right": "Segmentation category and type - Total Segmentator~SCT^123037004^Anatomical Structure~SCT^75297007^Gluteus minius muscle~SCT^24028007^Right~Anatomic codes - DICOM master list~^^~^^|",
